...
namespace Aliyun.Sls.Common.Authentication
{
    internal abstract class ServiceSignature
    {
        ...
        public string ComputeSignature(String key, String data)
        {
            if (string.IsNullOrEmpty(key))
                throw new ArgumentException(Aliyun.Sls.Properties.Resources.ExceptionIfArgumentStringIsNullOrEmpty, "key");
            if (string.IsNullOrEmpty(data))
                throw new ArgumentException(Aliyun.Sls.Properties.Resources.ExceptionIfArgumentStringIsNullOrEmpty, "data");
