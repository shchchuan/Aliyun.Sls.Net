...
//#endif
                                              ...
                                              ServiceRequest serviceRequest)
        {
            ...
            if (serviceRequest.Headers.ContainsKey(Aliyun.Sls.Common.Utilities.HttpHeaders.ContentLength))
            {
                userSetContentLength = long.Parse(serviceRequest.Headers[Aliyun.Sls.Common.Utilities.HttpHeaders.ContentLength]);
            }
